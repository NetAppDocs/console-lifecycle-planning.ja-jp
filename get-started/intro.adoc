...
[role="lead"]
ライフサイクルプランニングでは、現在または将来的に容量不足が予測されるストレージ資産を評価し、ビジネスニーズを満たすデータ階層化オプションに関する推奨事項を提供します。
...
* ライフサイクルイベントに近づいているシステムを特定し、システム更新の計画を支援します。
...
この機能には、NetApp Console（*Storage* > *Lifecycle planning*）またはActive IQ Digital Advisor（別名Digital Advisor）（*Dashboard* > *Planning widget* > *System refresh*）からアクセスできます。
